...
export default function ProductForm({_id, title:existingTitle, description:existingDescription, images:existingImages, category:assignedCategory, properties:assignedProperties}){
    ...
    async function saveProduct(ev){
        ...
        if(title == ""){
            ...
            const data = {title, description, images, category, properties: productProperties}
            if(_id){
                //update
